...
p=PostProcessor(".",inputFiles(),None,"z_hlt_sf_keep_and_drop.txt",[countHistogramsModule(),zHLTSFModule(),puWeight_2017(),PrefCorr()],provenance=True,justcount=False,fwkJobReport=True,jsonInput=runsAndLumis(),noOut=False,outputbranchsel="z_hlt_sf_output_branch_selection.txt")
